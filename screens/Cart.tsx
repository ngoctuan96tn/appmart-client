...
import { Text, View, ScrollView, TextInput, Image, TouchableOpacity, StyleSheet, Dimensions, SafeAreaView } from 'react-native';
...
export default class Cart extends Component<{}, any> {
  ...
  render() {
    return (
      <SafeAreaView style={{ flex: 1, alignItems: 'center', justifyContent: 'center' }}>
        ...
        <Text style={{ fontSize: 32, fontWeight: "bold", color: "#33c37d" }}>Danh sách giỏ hàng</Text>
  ...
  onChangeQuan(i: string | number, type: boolean) {
